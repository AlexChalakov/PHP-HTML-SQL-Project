...
<ul>
  ...
  <li><a class="active" href="add.php">Add data</a></li>
...
*/
	function validationcheck()
	{
		global $error;
		global $conn;
		$error = "Book successfully added!";//Introducing a message for when the function is true
...
echo '<b>If you would like a new book record fill in the below details and click on the "ADD RECORD" button! </b><br><br>';
		...
		)  
	{
		...
		if($validated)
		{
			$query    = "INSERT INTO books VALUES ('$id', '$title', '$author', '$pages', '$genre', '$yearpublished')";
